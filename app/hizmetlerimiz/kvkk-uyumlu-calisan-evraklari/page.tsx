...
export default function KvkkUyumluEvraklarPage() {
  const { translations } = useLanguage();
  const service = translations.services.serviceDetails.service2;
        ...
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-full max-w-[512px] aspect-[4/3] sm:aspect-[512/400] mx-auto overflow-hidden rounded-3xl shadow-xl">
              <Image
                src="/kvkk-uyumlu-calisan-evraklari.jpg"
                alt={service.title}
                fill
      ...
      <section className="py-20 bg-corporate text-white">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 text-white/90">
            {translations.servicePages.ctaDescriptions.service2}
          </p>
