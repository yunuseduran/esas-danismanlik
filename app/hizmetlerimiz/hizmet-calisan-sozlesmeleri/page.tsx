...
export default function HizmetCalisanSozlesmeleriPage() {
  const { translations } = useLanguage();
  const service = translations.services.serviceDetails.service6;
      ...
      <section className="py-20 bg-corporate text-white">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 text-white/90">
            {translations.servicePages.ctaDescriptions.service6}
          </p>
