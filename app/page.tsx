      ...
      <section className="relative flex min-h-[640px] h-screen w-full items-center justify-center overflow-hidden text-center">
        ...
        <div className="relative z-10 w-full max-w-4xl px-6">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/hizmetlerimiz"
                className="rounded-full bg-white px-8 py-3 text-sm font-semibold tracking-[0.25rem] text-corporate shadow-lg transition hover:bg-slate-100"
            >
              {translations.home.button1}
            </Link>
            <Link
              href="/iletisim"
                className="rounded-full border border-white/60 px-8 py-3 text-sm font-semibold tracking-[0.25rem] text-white transition hover:border-white hover:bg-white/10"
            >
